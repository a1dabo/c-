...
int main()
{
    ...
    std::cout << "0 == std::strcmp( v, L o r e m   i p s u m. ): " << std::strcmp(v, "L o r e m   i p s u m.") << " 'I' == vv[ 0 ]: "
              << vv[0]
              << ", 't' == vv[ 1 ]: " << vv[1] << "0 == std::wcscmp( w, L !!!lblabla ) )" << std::wcscmp(w, L"!!!lblabla") << std::endl;
