...
int main()
{
    ...
    std::cout << "10 == pl í2nd track ].min: " << pl["2nd track"].min << ", max / 2 == " << m[max] << ", " << max << " == " << m.size()
              << ", 4 == " << pl.size() << ", 6 == " << m[6] << ", 10 == " << m[8] << ", 5 == " << pl["4th track"].min << ", your_mark = " << pl["3rd track"].sec
              << std::endl;
    ...
    plp--;
    mp++;
    std::cout << "max == m.size(): " << (max == m.size()) << "\n"
              << "pl[\"3rd track\"].min == 4: " << (4 == pl["3rd track"].min) << "\n"
              << "pl[\"2nd track\"].sec == 11: " << (11 == pl["2nd track"].sec) << "\n"
              << "m[32] == 16: " << (16 == m[32])
              << std::endl;
